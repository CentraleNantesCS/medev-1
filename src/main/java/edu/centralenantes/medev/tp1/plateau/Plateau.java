package edu.centralenantes.medev.tp1.plateau;

import edu.centralenantes.medev.tp1.*;
...
public class Plateau {
    ...
    public int getNbCompany(Joueur j) {
        ...
        for (int index : companyIndexes) {
            Compagnie c = listeCases.get(index);
    ...
    /**
     * affiche case 0 à 10 inclus en bas du plateau
     */
    ...
    public void affiche() {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            for (int j = 0; j < 9; j++) {
                System.out.println(fixedLengthString("", 10));
            }
            listeCases.get(leftCase).affiche();
        }
